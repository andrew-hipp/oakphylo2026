...
if(!exists('treeplot.Final'))
  stop('52_PPT_ordWithLoadings.R needs treeplot.Final; run 20_ordination.R first.')
if(!exists('trees.envfit'))
  stop('52_PPT_ordWithLoadings.R needs trees.envfit; run 30_cladeLoadings.R first.')
